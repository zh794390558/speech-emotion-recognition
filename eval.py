            ...
            with tf.Session() as sess:
                ...
                if ckpt and ckpt.model_checkpoint_path:
                    ...
                    if(valid_size < FLAGS.valid_batch_size):
                        ...
                        y_pred_valid, loss = sess.run([model.softmax, cross_entropy], feed_dict = validate_feed)
                        ...
                        for v in range(valid_iter):
                            ...
                            loss, y_pred_valid[v_begin:v_end,:] = sess.run([cross_entropy, model.softmax], feed_dict = validate_feed)
                            cost_valid = cost_valid + np.sum(loss)
                    ...
                    if(flag):
                        ...
                        pickle.dump((best_valid_uw,best_valid_w,pred_test_w,test_acc_w,confusion_w,pred_test_uw,test_acc_uw,confusion_uw,),f)
                        f.close()
                        flag = False 
